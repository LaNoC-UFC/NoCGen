	...
	private String generateNocAttributions()
	{
		...
		for(int y = 0; y < maxY; y++)
		{
			for(int x = 0; x < maxX; x++)
			{
				...
				//	  3			|   credit_oNxxxx(?)
				//-------------------------------
				String[] eastRouterAddress  = new String[5];
				String[] westRouterAddress  = new String[5];
				String[] northRouterAddress = new String[5];
				String[] southRouterAddress = new String[5];
				...
				routerAttribution = 	routerAttribution +  
						...
						"	testLink_iN" + sourceRouterAddress + "(4)<=testLink_iLocal(N" + sourceRouterAddress + ");\n" +
